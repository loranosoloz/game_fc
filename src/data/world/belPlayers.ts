import players from '@/data/world/playersBel.json'
...
/** FM26 bel squads — keyed by club key */
export function belRosterForClub(clubKey: string): StarDef[] {
...
export function belRosterClubKeys(): string[] {
