import players from '@/data/world/playersSui.json'
...
/** FM26 sui squads — keyed by club key */
export function suiRosterForClub(clubKey: string): StarDef[] {
...
export function suiRosterClubKeys(): string[] {
