import players from '@/data/world/playersNed.json'
...
/** FM26 ned squads — keyed by club key */
export function nedRosterForClub(clubKey: string): StarDef[] {
...
export function nedRosterClubKeys(): string[] {
