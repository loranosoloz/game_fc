import players from '@/data/world/playersSau2.json'
...
/** FM26 Saudi First Division squads — keyed by club key */
export function sau2RosterForClub(clubKey: string): StarDef[] {
...
export function sau2RosterClubKeys(): string[] {
