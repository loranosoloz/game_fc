import players from '@/data/world/playersJpn.json'
...
/** FM26 jpn squads — keyed by club key */
export function jpnRosterForClub(clubKey: string): StarDef[] {
...
export function jpnRosterClubKeys(): string[] {
