import players from '@/data/world/playersDen.json'
...
/** FM26 den squads — keyed by club key */
export function denRosterForClub(clubKey: string): StarDef[] {
...
export function denRosterClubKeys(): string[] {
