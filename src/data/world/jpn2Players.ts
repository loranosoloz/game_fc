import players from '@/data/world/playersJpn2.json'
...
/** FM26 jpn2 squads — keyed by club key */
export function jpn2RosterForClub(clubKey: string): StarDef[] {
...
export function jpn2RosterClubKeys(): string[] {
