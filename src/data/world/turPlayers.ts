import players from '@/data/world/playersTur.json'
...
/** FM26 tur squads — keyed by club key */
export function turRosterForClub(clubKey: string): StarDef[] {
...
export function turRosterClubKeys(): string[] {
