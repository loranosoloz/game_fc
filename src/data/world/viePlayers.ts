import players from '@/data/world/playersVie.json'
...
/** FM26 vie squads — keyed by club key */
export function vieRosterForClub(clubKey: string): StarDef[] {
...
export function vieRosterClubKeys(): string[] {
