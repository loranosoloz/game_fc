import players from '@/data/world/playersSco.json'
...
/** FM26 sco squads — keyed by club key */
export function scoRosterForClub(clubKey: string): StarDef[] {
...
export function scoRosterClubKeys(): string[] {
