import players from '@/data/world/playersIdn.json'
...
/** FM26 idn squads — keyed by club key */
export function idnRosterForClub(clubKey: string): StarDef[] {
...
export function idnRosterClubKeys(): string[] {
