import players from '@/data/world/playersKor.json'
...
/** FM26 kor squads — keyed by club key */
export function korRosterForClub(clubKey: string): StarDef[] {
...
export function korRosterClubKeys(): string[] {
