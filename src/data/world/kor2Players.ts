import players from '@/data/world/playersKor2.json'
...
/** FM26 kor2 squads — keyed by club key */
export function kor2RosterForClub(clubKey: string): StarDef[] {
...
export function kor2RosterClubKeys(): string[] {
