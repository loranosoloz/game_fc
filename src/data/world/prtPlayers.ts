import players from '@/data/world/playersPrt.json'
...
/** FM26 prt squads — keyed by club key */
export function prtRosterForClub(clubKey: string): StarDef[] {
...
export function prtRosterClubKeys(): string[] {
