...
สถานะ: **Draft v1.2 — sync ก.ค. 2026 (§27)**  
หมายเหตุ: รายการนี้คือ **แคตตาล็อกระบบ** — ส่วนที่ ship แล้วดูเฟส §24 + sync §27 · ส่วน blueprint ยังเป็นเป้าหมายระยะยาว
...
| Traits / สกิลพิเศษ | พูลแยกตามตำแหน่ง (GK 10 · DF/MF/FW อย่างละ 30) ไม่ซ้ำข้ามตำแหน่ง · นักเตะมีได้สูงสุด 10 สกิล · มีผลโจมตี/รับในแมตช์เล็กน้อย |
...
UI: `/staff` + แท็บสตาฟใน `/browse`

**Responsibilities (มอบหมายงาน)** — เป้าหมายระยะยาว: ให้สตาฟทำต่อสัญญาอัตโนมัติ / สเกาต์คู่แข่ง ฯลฯ
...
| Social growth | ชนะ/แพ้หลังแมตช์เดย์ขยับ followers · ดูอันดับที่ `/media` |
...
| Calendar | ปฏิทินฤดูกาล / พรีซีซัน (`/calendar`) |
...
- **ทุกสโมสร + ทุกนักเตะมีบัญชีโซเชียล** (`Club.social` / `Player.social`) — handle, followers, engagement/brand หรือ heat
...
- ต่อสัญญาสูงสุด 3 รอบ · เอเยนต์โต้กลับค่าเหนื่อย/ปี · เซ็นแล้วหักค่าเอเยนต์จากบัญชีคลับ
...
รอบนี้ sync จากโค้ดจริง + career IndexedDB + UI `/browse`
