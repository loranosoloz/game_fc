...
| Illness | ป่วย (หวัด/ไข้/ท้อง/ไวรัส) — ไม่พร้อมลงแข่ง · ติดในห้องแต่งตัวได้ |
...
- **บอร์ด**: KPI / Club Vision · ความมั่นใจ · **คำขาด** · **ปลดผู้จัดการ** ถ้าไม่ผ่าน
- **แฟน**: มู้ด·faction·loyalty · **ประท้วง/คว่ำบาตรตั๋ว** กระทบรายได้สนาม
